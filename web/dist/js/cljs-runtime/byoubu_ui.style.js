...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",(function (){var iter__5480__auto__ = (function byoubu_ui$style$stops_str_$_iter__22840(s__22841){
return (new cljs.core.LazySeq(null,(function (){
var s__22841__$1 = s__22841;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22841__$1);
if(temp__5825__auto__){
var s__22841__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22841__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22841__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22843 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22842 = (0);
while(true){
if((i__22842 < size__5479__auto__)){
var map__22846 = cljs.core._nth(c__5478__auto__,i__22842);
var map__22846__$1 = cljs.core.__destructure_map(map__22846);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22846__$1,new cljs.core.Keyword("plate","color","plate/color",914427071));
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22846__$1,new cljs.core.Keyword("plate","at","plate/at",1101651535));
cljs.core.chunk_append(b__22843,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(color)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(at)].join(''));

var G__22887 = (i__22842 + (1));
i__22842 = G__22887;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22843),byoubu_ui$style$stops_str_$_iter__22840(cljs.core.chunk_rest(s__22841__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22843),null);
}
} else {
var map__22847 = cljs.core.first(s__22841__$2);
var map__22847__$1 = cljs.core.__destructure_map(map__22847);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22847__$1,new cljs.core.Keyword("plate","color","plate/color",914427071));
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22847__$1,new cljs.core.Keyword("plate","at","plate/at",1101651535));
return cljs.core.cons([cljs.core.str.cljs$core$IFn$_invoke$arity$1(color)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(at)].join(''),byoubu_ui$style$stops_str_$_iter__22840(cljs.core.rest(s__22841__$2)));
}
} else {
return null;
}
 ...
 */
byoubu_ui.style.layer_str = (function byoubu_ui$style$layer_str(p__22850){
var map__22851 = p__22850;
var map__22851__$1 = cljs.core.__destructure_map(map__22851);
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22851__$1,new cljs.core.Keyword("plate","kind","plate/kind",-1424213105));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22851__$1,new cljs.core.Keyword("plate","direction","plate/direction",-651904309));
var shape = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22851__$1,new cljs.core.Keyword("plate","shape","plate/shape",1889905040));
var stops = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22851__$1,new cljs.core.Keyword("plate","stops","plate/stops",-1312702775));
var G__22852 = kind;
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var iter__5480__auto__ = (function byoubu_ui$style$component_css_$_iter__22861(s__22862){
return (new cljs.core.LazySeq(null,(function (){
var s__22862__$1 = s__22862;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22862__$1);
if(temp__5825__auto__){
var s__22862__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22862__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22862__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22864 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22863 = (0);
while(true){
if((i__22863 < size__5479__auto__)){
var vec__22865 = cljs.core._nth(c__5478__auto__,i__22863);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22865,(0),null);
var decls = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22865,(1),null);
cljs.core.chunk_append(b__22864,css.core.rule(sel,decls));

var G__22912 = (i__22863 + (1));
i__22863 = G__22912;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22864),byoubu_ui$style$component_css_$_iter__22861(cljs.core.chunk_rest(s__22862__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22864),null);
}
} else {
var vec__22868 = cljs.core.first(s__22862__$2);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22868,(0),null);
var decls = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22868,(1),null);
return cljs.core.cons(css.core.rule(sel,decls),byoubu_ui$style$component_css_$_iter__22861(cljs.core.rest(s__22862__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5480__auto__ = (function byoubu_ui$style$component_css_$_iter__22871(s__22872){
return (new cljs.core.LazySeq(null,(function (){
var s__22872__$1 = s__22872;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22872__$1);
if(temp__5825__auto__){
var s__22872__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22872__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22872__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22874 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22873 = (0);
while(true){
if((i__22873 < size__5479__auto__)){
var vec__22877 = cljs.core._nth(c__5478__auto__,i__22873);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22877,(0),null);
var rules = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22877,(1),null);
cljs.core.chunk_append(b__22874,css.core.media(q,rules));

var G__22922 = (i__22873 + (1));
i__22873 = G__22922;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22874),byoubu_ui$style$component_css_$_iter__22871(cljs.core.chunk_rest(s__22872__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22874),null);
}
} else {
var vec__22881 = cljs.core.first(s__22872__$2);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22881,(0),null);
var rules = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22881,(1),null);
return cljs.core.cons(css.core.media(q,rules),byoubu_ui$style$component_css_$_iter__22871(cljs.core.rest(s__22872__$2)));
}
} else {
return null;
}
