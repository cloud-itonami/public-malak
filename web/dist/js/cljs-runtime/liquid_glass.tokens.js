...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__21993){
var map__21994 = p__21993;
var map__21994__$1 = cljs.core.__destructure_map(map__21994);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21994__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21994__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21994__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__22015(s__22016){
return (new cljs.core.LazySeq(null,(function (){
var s__22016__$1 = s__22016;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22016__$1);
if(temp__5825__auto__){
var s__22016__$2 = temp__5825__auto__;
...
var i = cljs.core._nth(c__5478__auto__,i__22017);
cljs.core.chunk_append(b__22018,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22157 = (i__22017 + (1));
i__22017 = G__22157;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22018),liquid_glass$tokens$iter__22015(cljs.core.chunk_rest(s__22016__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22018),null);
}
} else {
var i = cljs.core.first(s__22016__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__22015(cljs.core.rest(s__22016__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__22055(s__22056){
return (new cljs.core.LazySeq(null,(function (){
var s__22056__$1 = s__22056;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22056__$1);
if(temp__5825__auto__){
var s__22056__$2 = temp__5825__auto__;
...
var vec__22064 = cljs.core._nth(c__5478__auto__,i__22057);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22064,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22064,(1),null);
cljs.core.chunk_append(b__22058,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22167 = (i__22057 + (1));
i__22057 = G__22167;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22058),liquid_glass$tokens$pair__GT_css_$_iter__22055(cljs.core.chunk_rest(s__22056__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22058),null);
}
} else {
var vec__22071 = cljs.core.first(s__22056__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22071,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22071,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__22055(cljs.core.rest(s__22056__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22078(s__22079){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22091 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22091,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22091,(1),null);
var iterys__5476__auto__ = ((function (s__22079__$1,vec__22091,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22078_$_iter__22080(s__22081){
return (new cljs.core.LazySeq(null,((function (s__22079__$1,vec__22091,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22081__$1 = s__22081;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22081__$1);
if(temp__5825__auto____$1){
var s__22081__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22081__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22081__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22083 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22082 = (0);
while(true){
if((i__22082 < size__5479__auto__)){
var vec__22097 = cljs.core._nth(c__5478__auto__,i__22082);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22083,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22198 = (i__22082 + (1));
i__22082 = G__22198;
continue;
} else {
var G__22199 = (i__22082 + (1));
i__22082 = G__22199;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22083),liquid_glass$tokens$tokens__GT_body_$_iter__22078_$_iter__22080(cljs.core.chunk_rest(s__22081__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22083),null);
}
} else {
var vec__22104 = cljs.core.first(s__22081__$2);
...
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22078_$_iter__22080(cljs.core.rest(s__22081__$2)));
} else {
var G__22240 = cljs.core.rest(s__22081__$2);
s__22081__$1 = G__22240;
continue;
}
}
} else {
...
});})(s__22079__$1,vec__22091,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22079__$1,vec__22091,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22078(cljs.core.rest(s__22079__$1)));
} else {
var G__22242 = cljs.core.rest(s__22079__$1);
s__22079__$1 = G__22242;
continue;
}
} else {
return null;
