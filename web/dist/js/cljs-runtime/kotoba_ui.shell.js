 ...
 */
kotoba_ui.shell.with_root_attrs = (function kotoba_ui$shell$with_root_attrs(base,p__23408){
var map__23409 = p__23408;
var map__23409__$1 = cljs.core.__destructure_map(map__23409);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23409__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23409__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var attrs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23409__$1,new cljs.core.Keyword(null,"attrs","attrs",-2090668713));
var G__23412 = ((cljs.core.seq(attrs))?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,base], 0)):base);
var G__23412__$1 = (((!((class$ == null))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__23412,new cljs.core.Keyword(null,"class","class",-2030961996),kotoba_ui.shell.cls,kotoba_ui.shell.class_opt__GT_str(class$)):G__23412);
if((!((id == null)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23412__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__23412__$1;
}
});
...
var i__5727__auto___23491 = (0);
while(true){
if((i__5727__auto___23491 < len__5726__auto___23490)){
args__5732__auto__.push((arguments[i__5727__auto___23491]));

var G__23495 = (i__5727__auto___23491 + (1));
i__5727__auto___23491 = G__23495;
continue;
} else {
}
break;
...
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23423,(1),null);
var map__23426 = opts;
var map__23426__$1 = cljs.core.__destructure_map(map__23426);
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23426__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23426__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23426__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var justify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23426__$1,new cljs.core.Keyword(null,"justify","justify",-722524056));
...
/** @this {Function} */
(kotoba_ui.shell.stack.cljs$lang$applyTo = (function (seq23422){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23422));
}));
...
var G__23503 = (i__5727__auto___23501 + (1));
i__5727__auto___23501 = G__23503;
continue;
} else {
}
break;
...
var vec__23442 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23442,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23442,(1),null);
var map__23445 = opts;
var map__23445__$1 = cljs.core.__destructure_map(map__23445);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23445__$1,new cljs.core.Keyword(null,"title","title",636505583));
var wide = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23445__$1,new cljs.core.Keyword(null,"wide","wide",-151772487));
...
/** @this {Function} */
(kotoba_ui.shell.section.cljs$lang$applyTo = (function (seq23438){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23438));
}));
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23454__$1,new cljs.core.Keyword(null,"title","title",636505583));
var tagline = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23454__$1,new cljs.core.Keyword(null,"tagline","tagline",281987682));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23454__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
...
var G__23509 = (i__5727__auto___23506 + (1));
i__5727__auto___23506 = G__23509;
continue;
} else {
}
break;
...
var vec__23467 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23467,(0),null);
var cards = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23467,(1),null);
var map__23470 = opts;
var map__23470__$1 = cljs.core.__destructure_map(map__23470);
var min_w = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23470__$1,new cljs.core.Keyword(null,"min","min",444991522));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23470__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),kotoba_ui.shell.with_root_attrs((function (){var G__23474 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1 ? kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"grid","grid",402978600)) : kotoba_ui.shell.class_name.call(null, new cljs.core.Keyword(null,"grid","grid",402978600)))], null);
if(cljs.core.seq(style)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23474,new cljs.core.Keyword(null,"style","style",-496642736),style);
} else {
return G__23474;
}
})(),opts)], null),cards);
...
/** @this {Function} */
(kotoba_ui.shell.grid.cljs$lang$applyTo = (function (seq23462){
var self__5712__auto__ = this;
...
args__5732__auto__.push((arguments[i__5727__auto___23512]));
...
var vec__23476 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23476,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23476,(1),null);
var map__23479 = opts;
var map__23479__$1 = cljs.core.__destructure_map(map__23479);
var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23479__$1,new cljs.core.Keyword(null,"nav","nav",719540477));
var sidebar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23479__$1,new cljs.core.Keyword(null,"sidebar","sidebar",35784458));
...
/** @this {Function} */
(kotoba_ui.shell.app_shell.cljs$lang$applyTo = (function (seq23475){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23475));
}));
...
})()], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(appearance,"light"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__23486 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"theme-color",new cljs.core.Keyword(null,"content","content",15833224),dark], null);
if((appearance == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23486,new cljs.core.Keyword(null,"media","media",-1066138403),"(prefers-color-scheme: dark)");
} else {
return G__23486;
}
