...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22515(s__22516){
return (new cljs.core.LazySeq(null,(function (){
var s__22516__$1 = s__22516;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22516__$1);
if(temp__5825__auto__){
var s__22516__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22516__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22516__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22518 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22517 = (0);
while(true){
if((i__22517 < size__5479__auto__)){
var vec__22519 = cljs.core._nth(c__5478__auto__,i__22517);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22519,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22519,(1),null);
cljs.core.chunk_append(b__22518,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__22575 = (i__22517 + (1));
i__22517 = G__22575;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22518),byoubu$facts$declared_content_color_$_iter__22515(cljs.core.chunk_rest(s__22516__$2)));
} else {
...
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22526,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22515(cljs.core.rest(s__22516__$2)));
}
} else {
return null;
}
...
var G__22531 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22531__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22531,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22531);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22531__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22531__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22539){
...
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22540,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22544){
var vec__22545 = p__22544;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22545,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22545,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22538_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22538_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22557 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22557,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22557,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22557,(2),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22563),byoubu$facts$derive_facts_$_iter__22560(cljs.core.chunk_rest(s__22561__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22563),null);
}
} else {
var vec__22569 = cljs.core.first(s__22561__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22569,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22569,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22560(cljs.core.rest(s__22561__$2)));
}
} else {
return null;
}
