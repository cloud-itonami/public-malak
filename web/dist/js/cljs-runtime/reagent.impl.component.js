...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22467 = c;
...
var or__5002__auto__ = (function (){var G__22483 = c;
var G__22483__$1 = (((G__22483 == null))?null:G__22483.constructor);
if((G__22483__$1 == null)){
return null;
} else {
return G__22483__$1.displayName;
}
})();
...
var G__22484 = c;
var G__22484__$1 = (((G__22484 == null))?null:G__22484.constructor);
if((G__22484__$1 == null)){
return null;
} else {
return G__22484__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22485 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22486 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22486);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22485);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__22487 = key;
var G__22487__$1 = (((G__22487 instanceof cljs.core.Keyword))?G__22487.fqn:null);
switch (G__22487__$1) {
...
var c = this;
var G__22523_22675 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22523_22675 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22523_22675);
}
...
var renders_22680 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22681 = cljs.core.first(cljs.core.vals(renders_22680));
...
if((cljs.core.count(renders_22680) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22680))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22681)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22681], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22543 = o;
reagent.impl.component.goog$module$goog$object.set(G__22543,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22585 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22586 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22586);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22585);
}});
...
var G__22594 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22594 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22594);
}
});
}),[]);
