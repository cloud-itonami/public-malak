...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22997){
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23060){
var vec__23061 = p__23060;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23061,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23061,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23074){
var vec__23075 = p__23074;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23075,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23075,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__23096(s__23097){
return (new cljs.core.LazySeq(null,(function (){
var s__23097__$1 = s__23097;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23097__$1);
if(temp__5825__auto__){
var s__23097__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23097__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23097__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23099 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23098 = (0);
while(true){
if((i__23098 < size__5479__auto__)){
var vec__23100 = cljs.core._nth(c__5478__auto__,i__23098);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23100,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23100,(1),null);
cljs.core.chunk_append(b__23099,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__23309 = (i__23098 + (1));
i__23098 = G__23309;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23099),shitsuke$hig$pair__GT_css_$_iter__23096(cljs.core.chunk_rest(s__23097__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23099),null);
}
} else {
var vec__23103 = cljs.core.first(s__23097__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23103,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23103,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__23096(cljs.core.rest(s__23097__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__23108(s__23109){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__23115 = cljs.core._nth(c__5478__auto__,i__23110);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23115,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23115,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__23111,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__23110,s__23109__$1,vec__23115,group,m,c__5478__auto__,size__5479__auto__,b__23111,s__23109__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23108_$_iter__23119(s__23120){
return (new cljs.core.LazySeq(null,((function (i__23110,s__23109__$1,vec__23115,group,m,c__5478__auto__,size__5479__auto__,b__23111,s__23109__$2,temp__5825__auto__){
return (function (){
var s__23120__$1 = s__23120;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23120__$1);
if(temp__5825__auto____$1){
var s__23120__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__23120__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__23120__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__23122 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__23121 = (0);
while(true){
if((i__23121 < size__5479__auto____$1)){
var vec__23123 = cljs.core._nth(c__5478__auto____$1,i__23121);
...
if((!((v == null)))){
cljs.core.chunk_append(b__23122,shitsuke.hig.pair__GT_css(group,k,v));

var G__23315 = (i__23121 + (1));
i__23121 = G__23315;
continue;
} else {
var G__23316 = (i__23121 + (1));
i__23121 = G__23316;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23122),shitsuke$hig$tokens__GT_css_lines_$_iter__23108_$_iter__23119(cljs.core.chunk_rest(s__23120__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23122),null);
}
} else {
var vec__23129 = cljs.core.first(s__23120__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23129,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23129,(1),null);
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23108_$_iter__23119(cljs.core.rest(s__23120__$2)));
} else {
var G__23317 = cljs.core.rest(s__23120__$2);
s__23120__$1 = G__23317;
continue;
}
}
} else {
...
});})(i__23110,s__23109__$1,vec__23115,group,m,c__5478__auto__,size__5479__auto__,b__23111,s__23109__$2,temp__5825__auto__))
,null,null));
});})(i__23110,s__23109__$1,vec__23115,group,m,c__5478__auto__,size__5479__auto__,b__23111,s__23109__$2,temp__5825__auto__))
;
...
var G__23318 = (i__23110 + (1));
i__23110 = G__23318;
continue;
} else {
var G__23319 = (i__23110 + (1));
i__23110 = G__23319;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23111),shitsuke$hig$tokens__GT_css_lines_$_iter__23108(cljs.core.chunk_rest(s__23109__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23111),null);
}
} else {
var vec__23133 = cljs.core.first(s__23109__$2);
...
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__23109__$1,vec__23133,group,m,s__23109__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23108_$_iter__23140(s__23141){
return (new cljs.core.LazySeq(null,((function (s__23109__$1,vec__23133,group,m,s__23109__$2,temp__5825__auto__){
return (function (){
var s__23141__$1 = s__23141;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23141__$1);
if(temp__5825__auto____$1){
var s__23141__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__23141__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23141__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23143 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23142 = (0);
while(true){
if((i__23142 < size__5479__auto__)){
var vec__23154 = cljs.core._nth(c__5478__auto__,i__23142);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23154,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23154,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__23143,shitsuke.hig.pair__GT_css(group,k,v));

var G__23324 = (i__23142 + (1));
i__23142 = G__23324;
continue;
} else {
var G__23325 = (i__23142 + (1));
i__23142 = G__23325;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23143),shitsuke$hig$tokens__GT_css_lines_$_iter__23108_$_iter__23140(cljs.core.chunk_rest(s__23141__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23143),null);
}
} else {
var vec__23157 = cljs.core.first(s__23141__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23108_$_iter__23140(cljs.core.rest(s__23141__$2)));
} else {
var G__23326 = cljs.core.rest(s__23141__$2);
s__23141__$1 = G__23326;
continue;
}
}
} else {
...
});})(s__23109__$1,vec__23133,group,m,s__23109__$2,temp__5825__auto__))
,null,null));
});})(s__23109__$1,vec__23133,group,m,s__23109__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__23108(cljs.core.rest(s__23109__$2)));
} else {
var G__23327 = cljs.core.rest(s__23109__$2);
s__23109__$1 = G__23327;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__23224(s__23225){
return (new cljs.core.LazySeq(null,(function (){
var s__23225__$1 = s__23225;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23225__$1);
if(temp__5825__auto__){
var s__23225__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23225__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23225__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23227 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23226 = (0);
while(true){
if((i__23226 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__23226);
cljs.core.chunk_append(b__23227,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__23339 = (i__23226 + (1));
i__23226 = G__23339;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23227),shitsuke$hig$iter__23224(cljs.core.chunk_rest(s__23225__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23227),null);
}
} else {
var style = cljs.core.first(s__23225__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__23224(cljs.core.rest(s__23225__$2)));
}
} else {
return null;
}
