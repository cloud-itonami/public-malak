...
var h__$1 = (function (){var G__22366 = h;
if(clojure.string.starts_with_QMARK_(h,"#")){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__22366,(1));
} else {
return G__22366;
}
})();
 ...
 */
byoubu.color.rgb__GT_hex = (function byoubu$color$rgb__GT_hex(p__22369){
var vec__22370 = p__22369;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22370,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22370,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22370,(2),null);
...
var vec__22376 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22376,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22376,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22376,(2),null);
...
var pairs = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__22382){
var vec__22383 = p__22382;
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22383,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22383,(1),null);
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
...
if((total > (0))){
return byoubu.color.rgb__GT_hex((function (){var iter__5480__auto__ = (function byoubu$color$mix_$_iter__22388(s__22389){
return (new cljs.core.LazySeq(null,(function (){
var s__22389__$1 = s__22389;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22389__$1);
if(temp__5825__auto__){
var s__22389__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22389__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22389__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22391 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22390 = (0);
while(true){
if((i__22390 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__22390);
cljs.core.chunk_append(b__22391,(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__22390,i,c__5478__auto__,size__5479__auto__,b__22391,s__22389__$2,temp__5825__auto__,pairs,total){
return (function (p__22394){
var vec__22395 = p__22394;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22395,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22395,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i__22390,i,c__5478__auto__,size__5479__auto__,b__22391,s__22389__$2,temp__5825__auto__,pairs,total))
,pairs)) / total));

var G__22482 = (i__22390 + (1));
i__22390 = G__22482;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22391),byoubu$color$mix_$_iter__22388(cljs.core.chunk_rest(s__22389__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22391),null);
}
} else {
var i = cljs.core.first(s__22389__$2);
return cljs.core.cons((cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i,s__22389__$2,temp__5825__auto__,pairs,total){
return (function (p__22399){
var vec__22400 = p__22399;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22400,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22400,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i,s__22389__$2,temp__5825__auto__,pairs,total))
,pairs)) / total),byoubu$color$mix_$_iter__22388(cljs.core.rest(s__22389__$2)));
}
} else {
return null;
}
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22404 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22404,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22404,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22404,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22410 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22410,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22410,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22410,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
var mx = (function (){var x__5087__auto__ = (function (){var x__5087__auto__ = r__$1;
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22419 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22419,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22419,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22419,(2),null);
